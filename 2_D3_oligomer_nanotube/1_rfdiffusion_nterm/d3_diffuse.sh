...
contigmap.contigs=[\'"$len_N"-"$len_N",A"$keep_start"-"$keep_end","$len_C"-"$len_C",0\ "$len_N"-"$len_N",B"$keep_start"-"$keep_end","$len_C"-"$len_C",0\ "$len_N"-"$len_N",C"$keep_start"-"$keep_end","$len_C"-"$len_C",0\ "$len_N"-"$len_N",D"$keep_start"-"$keep_end","$len_C"-"$len_C",0\ "$len_N"-"$len_N",E"$keep_start"-"$keep_end","$len_C"-"$len_C",0\ "$len_N"-"$len_N",F"$keep_start"-"$keep_end","$len_C"-"$len_C"\'] \
