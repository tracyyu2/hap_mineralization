...
# Define parameters
input_directory = "/home/tracyy2/fiber_design/Dihedral/00_dihedral_rosetta/"
input_pdbs = [os.path.join(input_directory, f) for f in os.listdir(input_directory) if f.endswith(".pdb")]
num_designs = 5
weight_intras = 1
weight_inters = 1
len_Ns = []  # If len_Ns should be empty, leave it as an empty list.
len_Cs = [24, 26, 28, 30, 32, 34]  # Multiple length values for len_C to test
keep_start = 143
keep_end = 265  # (start, end)
